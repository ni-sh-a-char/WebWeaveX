...
if __name__ == "__main__":
    ...
    result["physical_shims_ok"] = Path("core/repository/event_topology_engine.py").exists()
    result["facade_split_ok"] = Path("core/extract/facades/repository_facade.py").exists()
