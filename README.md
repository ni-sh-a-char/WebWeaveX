...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/coverage-96.55%25%20instruction-22c55e?style=flat-square" alt="Coverage"/>
  <img src="https://img.shields.io/badge/API%20parity-90%20%2F%20128%20proven-3b82f6?style=flat-square" alt="API parity"/>
...
| Java implemented (parity-proven) | **90** |
| Java planned | 38 |
| Parity tests | **849 passing**, 0 failures, 0 errors |
| Instruction coverage (JaCoCo) | **96.55 %** |

Proven APIs today (90) span the determinism + crypto foundation, kernel/graph/IR,
...
| [`parity-regression.yml`](.github/workflows/parity-regression.yml) | Coverage floor (94 %) + proven-API floor (90) + manifest drift |
