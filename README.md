...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1039%20passing-22c55e?style=flat-square" alt="Tests"/>
  <img src="https://img.shields.io/badge/coverage-96.69%25%20instruction-22c55e?style=flat-square" alt="Coverage"/>
  <img src="https://img.shields.io/badge/API%20parity-94%20%2F%20128%20proven-3b82f6?style=flat-square" alt="API parity"/>
...
| Java implemented (parity-proven) | **94** |
| Java planned | 34 |
| Parity tests | **1039 passing**, 0 failures, 0 errors |
| Instruction coverage (JaCoCo) | **96.69 %** |

Proven APIs today (94) span the determinism + crypto foundation, kernel/graph/IR,
...
| [`parity-regression.yml`](.github/workflows/parity-regression.yml) | Coverage floor (94 %) + proven-API floor (94) + manifest drift |
