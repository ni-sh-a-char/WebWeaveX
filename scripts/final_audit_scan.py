#!/usr/bin/env python3
"""v21 master audit scanner — outputs JSON summary for v21_MASTER_AUDIT.md."""
...
def main():
    ...
    (ROOT / "scripts" / "final_audit_summary.json").write_text(
        json.dumps(summary, indent=2), encoding="utf-8"
    )
    (ROOT / "scripts" / "final_module_classifications.json").write_text(
