...
| Status | Count | Notes |
|--------|------:|-------|
| ✅ Complete | 105 | name-mapped + cross-language proof-verified (see COMPLETE_API_PROOF_MATRIX.md) |
| 🟡 Partial | 18 | bounded Dart impl; full parity needs live network/browser/NLP/AST (incl. `heal_selector`, `replay_interactions`) |
| ⚪ Deferred | 5 | needs OS/desktop/Electron/DevTools — not in-process in Dart |
| ❌ Missing | 0 | — |
