...
| Status | Count | Notes |
|--------|------:|-------|
| ✅ Complete | 94 | name-mapped + cross-language proof-verified (see COMPLETE_API_PROOF_MATRIX.md) |
| 🟡 Partial | 26 | bounded Dart impl; full parity needs live network/browser/NLP/AST (incl. `heal_selector`, `replay_interactions`) |
| ⚪ Deferred | 8 | needs OS/desktop/Electron/DevTools — not in-process in Dart |
| ❌ Missing | 0 | — |
