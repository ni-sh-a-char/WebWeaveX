/**
 * Converted from Python: core/workflows/workflow_checkpoint_engine.py
...
export function saveWorkflowCheckpoint(path: any, checkpoint: any, key: any): any {
...
export function loadWorkflowCheckpoint(path: any, key: any): any {
  var target: any = py.path(path);
...
export function _emptyCheckpoint(): any {
  return {"execution_state": {}, "distributed_tasks": [], "semantic_alignment": {}, "runtime_context": {}, "bounded": true};
}
