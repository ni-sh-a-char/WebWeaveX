/**
 * Converted from Python: core/execution/runtime_checkpoint_engine.py
...
export function saveExecutionCheckpoint(path: any, checkpoint: any, key: any): any {
...
export function loadExecutionCheckpoint(path: any, key: any): any {
  var target: any = py.path(path);
...
export function _emptyCheckpoint(): any {
  return {"state": {}, "transactions": [], "mutations": [], "workflows": {}, "synchronization": {}, "queues": [], "bounded": true};
}
