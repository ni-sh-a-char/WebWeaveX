...
**Version:** 2.0.0  
**Generated:** 2026-05-22T17:36:45Z  
**Python:** 3.11.0  
**Platform:** win32
...
- **https://example.com**: DOM 11, links 1, network 1, graph 2/0, 3137.9 ms
- **https://news.ycombinator.com**: DOM 810, links 190, network 6, graph 2/0, 3893.1 ms
- **https://github.com**: DOM 2028, links 129, network 151, graph 2/0, 8773.56 ms
- **https://docs.python.org**: DOM 472, links 56, network 20, graph 2/0, 2897.8 ms
- **https://httpbin.org**: DOM 222, links 16, network 10, graph 2/0, 5680.98 ms
...
- extract_web_ms: **2172.48 ms**
- extract_repository_ms: **3484.26 ms**
